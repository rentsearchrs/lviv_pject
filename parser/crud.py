...
async def release_apartment_lock(db: AsyncSession, apartment: Apartment, success: bool):
    """
...
async def filter_apartment(db: AsyncSession, apartment_data: dict):
    ...
    return "ok"
async def create_or_update_apartment(db: AsyncSession, apartment_data: dict):
...
async def get_latest_scraped_urls(db: AsyncSession):
    """
